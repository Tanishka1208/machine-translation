...
class NoamScheduler(LRScheduler):
    ...
    def __init__(
        ...
        # Store d_model and warmup_steps as instance attributes BEFORE super().__init__
        # because super().__init__ calls get_lr() internally
    ...
    def _get_lr_scale(self) -> float:
        ...
        """
        step = self.last_epoch + 1   # avoid division by zero at step 0
